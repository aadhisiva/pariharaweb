...
import { routesOfSuperAdmin, routesOfDistrict, routesOfGp, routesOfTaluk, routesOfAdmin } from '../utils/constData';
...
function SidebarWIthHeader({ children }) {
  ...
  let routes = (RoleAccess?.District == "Yes" && RoleAccess?.Type == "Admin") ?
    routesOfSuperAdmin : RoleAccess?.District == "Yes" ?
